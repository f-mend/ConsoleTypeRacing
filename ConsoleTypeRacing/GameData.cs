...
namespace ConsoleTypeRacing
{
    internal class GameData
    {
        ...
        private void GetUsernameAndPassword()
        {
            ...
            Dictionary<string,string> credentials = lines
        ...
        private void HTTPGetRequest()
        {
            ...
            HttpResponseMessage response = _HTTPClient.GetAsync($"https://data.typeracer.com/api/v1/texts/{RandNum}").Result;
        ...
        private void ParseToJson()
        {
            ...
            _jsonRoot = doc.RootElement;
        }

        public string GetGameText()
        {
            return _jsonRoot.GetProperty("data").GetProperty("text").GetString();
        }
    }
}
